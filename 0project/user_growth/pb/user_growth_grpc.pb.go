...
const (
	UserCoin_ListTask_FullMethodName       = "/UserGrowth.UserCoin/ListTask"
...
func (c *userCoinClient) ListTask(ctx context.Context, in *ListTaskRequest, opts ...grpc.CallOption) (*ListTaskReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListTaskReply)
	err := c.cc.Invoke(ctx, UserCoin_ListTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserCoinServer) ListTask(context.Context, *ListTaskRequest) (*ListTaskReply, error) {
...
func _UserCoin_ListTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListTaskRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserCoinServer).ListTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserCoin_ListTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserCoinServer).ListTask(ctx, req.(*ListTaskRequest))
	}
...
var UserCoin_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ListTask",
			Handler:    _UserCoin_ListTask_Handler,
		},
		{
