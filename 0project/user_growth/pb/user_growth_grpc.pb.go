...
// UnimplementedUserCoinServer must be embedded to have
...
func (UnimplementedUserCoinServer) testEmbeddedByValue()                  {}
...
func RegisterUserCoinServer(s grpc.ServiceRegistrar, srv UserCoinServer) {
	// If the following call pancis, it indicates UnimplementedUserCoinServer was
...
// UnimplementedUserGradeServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedUserGradeServer) testEmbeddedByValue()                   {}
...
func RegisterUserGradeServer(s grpc.ServiceRegistrar, srv UserGradeServer) {
	// If the following call pancis, it indicates UnimplementedUserGradeServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
